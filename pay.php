              ...
              <div class="page-header">
                    ...
                    <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post">
                        <div class="form-group <?php echo (!empty($contrato_err)) ? 'has-error' : ''; ?>">
                            ...
                            <input name="contrato" class="form-control" value="<?php echo $contrato ?>" disabled></input>
                        </div>
                        <div class="form-group <?php echo (!empty($abonado_err)) ? 'has-error' : ''; ?>">
                            <label>Abonado</label>
                            <input name="abonado" class="form-control" value="<?php echo $abonado; ?>" disabled></input>
                        </div>
                        <div class="form-group <?php echo (!empty($propiedad_err)) ? 'has-error' : ''; ?>">
                            <label>Propiedad</label>
                            <input name="propiedad" class="form-control" value="<?php echo $propiedad; ?>" disabled></input>
                        </div>
                        <div class="form-group <?php echo (!empty($pagomes)) ? 'has-error' : ''; ?>">
                            <label>Pago Mes</label>
                            <input name="pagomes" class="form-control" value="<?php echo $pagomes; ?>" ></input>
                        </div>
